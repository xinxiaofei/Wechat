...
const accessTokenJson = require('../wechat/access_token.json'); //引入本地存储的 access_token
const jsapiTicketJson = require('../wechat/jsapi_ticket.json'); //引入本地存储的 jsapi_ticket
